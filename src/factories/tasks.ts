...
import { GetUniqueTaskRepository } from "../repositories/tasks/get-unique-task";
...
import { GetUniqueTaskUseCase } from "../use-cases/tasks/get-unique-task";
...
export const getUniqueTaskFactory = () => {
  const getUniqueTaskRepository = new GetUniqueTaskRepository();
  const getUniqueTaskUseCase = new GetUniqueTaskUseCase(
    getUniqueTaskRepository,
  );
  const getUniqueTaskController = new GetUniqueTaskController(
    getUniqueTaskUseCase,
  );

  return getUniqueTaskController;
};
